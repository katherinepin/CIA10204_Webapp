...
<table>
	...
	<tr>
		<td>員工姓名:</td>
		<td><input type="TEXT" name="empName" value="<%= (empVO==null)? "kathy4" : empVO.getEmpName()%>" size="45"/></td>  <%-- empVO.getEname()撈已key的值 --%>
	</tr>
	<tr>
		<td>帳號:</td>
	...
	<tr>
		<td>地址:</td>
		<td><input type="TEXT" name="empAddress"   value="<%= (empVO==null)? "台中市" : empVO.getEmpAddress()%>" size="45"/></td>
	</tr>
