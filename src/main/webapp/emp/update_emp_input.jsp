...
<table>
	...
	<tr>
		<td>密碼:</td>
		<td><input type="TEXT" name="empPassword"   value="<%=empVO.getEmpPassword()%>" size="45"/></td>
	</tr>
	<tr>
		<td>手機:</td>
...
<tr>
		<td>地址:</td>
		<td><input type="TEXT" name="empAddress"   value="<%=empVO.getEmpAddress()%>" size="45"/></td>
	</tr>

	<tr>
		<td>電子郵件:</td>
		<td><input type="TEXT" name="empEmail"   value="<%=empVO.getEmpEmail()%>" size="45"/></td>
	</tr>
	<tr>
		<td>雇用日期:</td>
	    ...
	    <td><select size="1" name="empStatus">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <option value="1" selected>離職</option>
                </c:otherwise>
            </c:choose>
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=empVO.getEmpHiredate()%>', // value:   new Date(),
